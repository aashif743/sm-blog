...
export default function DashProfile() {
  ...
  const uploadImage = async () => {
    ...
    try {
      // Step 1: Request a signature and other credentials from the backend
      ...
      formData.append('folder', 'user_profiles'); // Optional: Specify a folder in Cloudinary
      ...
      setImageFileUrl(uploadData.secure_url);
      setFormData({ ...formData, profilePicture: uploadData.secure_url });
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        {currentUser.isAdmin && (
          <Link to={'/create-post'}>
            <Button
              type='button'
              gradientDuoTone='orangeToYellow' 
